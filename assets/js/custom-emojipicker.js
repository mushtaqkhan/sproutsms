...
function convert() {
    var targetDiv = document.getElementById('myDropdown'); // Replace 'yourTargetDivId' with the actual ID of your target div

    // Check if the target div exists
    if (targetDiv) {
        targetDiv.innerHTML = twemoji.parse(targetDiv.innerHTML);
    }
}
...
//   }
  ...
  $(document).delegate('.emoji-header a', 'click', function() {
    index = $(this).index()
    $('.emoji-panel').css({
...
//   });  
  ...
  $('.emoji-message').on('keypress', function(event) {
  ...
  $('.emoji-panel .emojicon').on('click', function() {
    // Get the alt attribute of the selected emoji
    var emojiAlt = $('img', this).attr('alt');
    var emojiSrc = $('img', this).attr('src');
    $('img', this).css('width', '-webkit-fill-available');
    // Display the selected emoji in the .emoji-message element
    var emojiImage = $('img', this).clone();
    $('.emoji-message').html(emojiImage);

    // Get the phone number from the input field
    var phone_number = $('#phone_number').val();
    
    // Check if the phone number is not empty before making the AJAX request
    if (phone_number.trim() !== '') {
        // Send the emojiAlt value to the server using AJAX
        $.ajax({
            url: 'process/process_settings.php',
            type: 'POST',
            data: {"action": "emoji_Alt", 'emojiAlt': emojiAlt, 'phone_number': phone_number, 'emojiSrc':emojiSrc}, 
